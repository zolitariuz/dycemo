	...
	<div class="metabox-holder mbright">
		...
		<div class="postbox">
            ...
            <div class="inside">
                ...
                <select name="<?php echo $settings; ?>[slider_interval]">
                    ...
                    <option style="padding-right:10px;" value="999999999" <?php selected('999999999', ot_option('slider_interval')); ?>><?php _e("Hold Frame", 'organicthemes'); ?></option>
                </select></p>
        ...
        <div class="postbox">
			...
			<div class="inside">
				...
				<input type="text" name="<?php echo $settings; ?>[blog_num]" value="<?php echo ot_option('blog_num'); ?>" size="3" /></p>
			</div>
		</div>
